  ...
  return (
    <div className="grid grid-rows-[auto_20px_1fr_20px] items-center justify-items-center min-h-screen  pb-20 gap-16  font-[family-name:var(--font-geist-sans)]">
      ...
      <footer className="row-start-4 flex gap-6 flex-wrap items-center justify-center">
        <a
          className="rounded focus:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:ring-offset-2 transition-all flex items-center gap-2 hover:underline hover:underline-offset-4"
